...
var globalFn = {
    ...
    //预览Id viewId
    //隐藏域Id
    webUpload:function(path, token, viewId, hideId, showId){
        // 初始化Web Uploader
        ...
        uploader.on( 'uploadSuccess', function( file, res) {
            console.log(res);
            $('#'+hideId).val(res.saveUrl); //大图地址  input
            $('#'+viewId+' img').attr('src', res.imgUrl);
            showId && $('#'+showId+' img').attr('src', res.imgUrl);
